        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    PremiumPaymentId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    CropInsuranceId = table.Column<int>(type: "int", nullable: true),
                    CropInsurncePremiumId = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CropInsurancePremiums_PremiumPayments",
                        column: x => x.CropInsurncePremiumId,
                        principalTable: "CropInsurancePremiums",
                        principalColumn: "CropInsurancePremiumId");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CropInsurancePremiums_PremiumPayments_AU",
                        column: x => x.CropInsurancePremiumId,
                        principalTable: "CropInsurancePremiums",
                        principalColumn: "CropInsurancePremiumId");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Claims_CropInsurancePremiumId",
                table: "Claims",
                column: "CropInsurancePremiumId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Claims_AU_CropInsurancePremiumId",
                table: "Claims_AU",
                column: "CropInsurancePremiumId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PremiumPayments_CropInsurncePremiumId",
                table: "PremiumPayments",
                column: "CropInsurncePremiumId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PremiumPayments_AU_CropInsurancePremiumId",
                table: "PremiumPayments_AU",
                column: "CropInsurancePremiumId");
