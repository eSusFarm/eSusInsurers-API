...
namespace eSusInsurers.Services.Interfaces
{
    public interface ICountriesService
    {
        ...
        Task<List<DistrictModel>> GetDistrictsByFirstThreeCharacters(long countryId, long regionId, CancellationToken cancellationToken, String searchText);

        Task<List<ParishModel>?> GetParishesByFirstThreeCharacters(long countryId, long regionId, long districtId, long subCountyId, CancellationToken cancellationToken, String searchText);

        Task<List<SubCountiesModel>?> GetSubcountiesByFirstThreeCharacters(long countryId, long regionId,
            long districtId, CancellationToken cancellationToken, String searchText);
    }
}
