...
namespace eSusInsurers.Services.Interfaces
{
    public interface IEtheriscService
    {
        ...
        Task<UpdateRiskResponse> UpdateRisk(UpdateRiskRequest request, CancellationToken cancellationToken);
        Task<string> SyncRisk(string riskId, CancellationToken cancellationToken);
    }
}
