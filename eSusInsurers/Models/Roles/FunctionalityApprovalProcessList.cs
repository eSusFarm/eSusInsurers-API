...
public class FunctionalityApprovalProcessList : IMapFrom<FunctionalityApprovalProcess>,
    IMapFrom<MenuRoleFunctionalityApprovalProcess>
{
    ...
    public void Mapping(Profile profile)
    {
        profile.CreateMap<FunctionalityApprovalProcess, FunctionalityApprovalProcessList>()
            ...
            .ForMember(dest => dest.ApplicationFunctionalityId,
                opt => opt.MapFrom(src => src.ApplicationFunctionalityId))
        ...
        profile.CreateMap<FunctionalityApprovalProcessList, MenuRoleFunctionalityApprovalProcess>()
            .ForMember(dest => dest.FunctionalityApprovalProcessId,
                opt => opt.MapFrom(src => src.FunctionalityApprovalProcessId))
