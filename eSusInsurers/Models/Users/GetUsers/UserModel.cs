...
public class UserModel : IMapFrom<User>
{
    ...
    [JsonIgnore] public string CreatedBy { get; set; } = null!;
    ...
    public void Mapping(Profile profile)
    {
        profile.CreateMap<User, UserModel>()
            ...
            .ForMember(d => d.ReportingTo,
                opt => opt.MapFrom(c =>
                    c.ReportingTo.HasValue
                        ? c.ReportingToNavigation.FirstName + " " + c.ReportingToNavigation.LastName
                        : ""));
    }
}