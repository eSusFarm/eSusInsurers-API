...
public class SeasonCutOffDatesController(ISeasonCutOffDateService seasonCutOffDateService) : ControllerBase
{
    ...
    public async Task<ActionResult<GetSeasonCutOffDatesResponse>> GetSeasonCutOffDates(
    ...
    public async Task<ActionResult<SeasonCutOffDatesModel>> GetSeasonCutOffDatesById(int seasonCutOffDateId)
    {
        ...
        {
            var result =
                await seasonCutOffDateService.GetSeasonCutOffDatesById(seasonCutOffDateId, new CancellationToken());
    ...
    public async Task<IActionResult> UpdateSeasonCutOffDates(int seasonCutOffDateId,
        [FromBody] UpdateSeasonCutOffDatesRequest request)
    {
        try
        {
    ...
    public async Task<IActionResult> DeleteSeasonCutOffDates(int seasonCutOffDateId)
    {
        ...
        {
            var response =
                await seasonCutOffDateService.DeleteSeasonCutOffDates(seasonCutOffDateId, new CancellationToken());
            return NoContent();
        }
        catch (Exception e)
        {
    ...
    [HttpPut("{seasonCutOffDateId}/activate")]
    [Authorize]
    [ProducesResponseType(StatusCodes.Status204NoContent)]
    public async Task<IActionResult> ActivateSeason(int seasonCutOffDateId)
    {
        ...
        {
            var response =
                await seasonCutOffDateService.ActivateSeasonCutOffDates(seasonCutOffDateId, new CancellationToken());
            return NoContent();
        }
        catch (Exception e)
        {
    ...
    public async Task<IActionResult> SeasonCutOffDatesExistenceCheck([FromBody] SeasonCutOffDatesRequest request)
    {
        ...
        {
            var response =
                await seasonCutOffDateService.SeasonCutOffDatesExistenceCheck(request, new CancellationToken());
