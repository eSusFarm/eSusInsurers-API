...
namespace eSusInsurers.ConfigServices
{
    ...
    public static class EnvironmentVariablesHelper
    {
        ...
        public static IConfiguration AddEnvironmentVariables(this IServiceCollection services, IWebHostEnvironment? env)
        {
            ...
            if (environmentName == "Development" || environmentName == "local")
            {
                builder.AddJsonFile("appsettings.Development.json", optional: true, reloadOnChange: true);
                Console.WriteLine("DEV Environment variable appsettings.Development.json");
            }
            else
            {
                builder.AddJsonFile($"appsettings.{environmentName}.json", optional: true, reloadOnChange: true);
                Console.WriteLine(environmentName + " Environment variable appsettings." + environmentName +".json");
